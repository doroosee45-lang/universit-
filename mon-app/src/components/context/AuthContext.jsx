...
// ─── Role → route mapping (source unique de vérité) ──────────────────────────
const ROLE_ROUTES = {
...
export const AuthProvider = ({ children }) => {
  ...
  // Retourne { token, user, mustChangePassword } pour la navigation immédiate
  ...
  // Appelé après changement forcé du mot de passe
