...
export default function AdminJuryPage() {
  ...
  if (!isAdmin && !isSuperAdmin) {
    return (
      <div style={{ textAlign: 'center', padding: 60, fontFamily: T.font }}>
        <ShieldCheck size={48} color={T.rose} style={{ marginBottom: 16 }} />
        <h2 style={{ color: T.navy }}>Accès non autorisé</h2>
        <p style={{ color: T.slate }}>Cette page est réservée à l’administration.</p>
      </div>
    );
  }
